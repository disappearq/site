			...
			((a = n.fancybox.getInstance()) && a.$trigger && a.$trigger.is(o)) ||
				(e.selector
					...
					: ((i = o.attr('data-fancybox') || ''),
					  i
							? ((s = t.data ? t.data.items : []), (s = s.length ? s.filter('[data-fancybox="' + i + '"]') : n('[data-fancybox="' + i + '"]')))
							: (s = [o])),
				(r = n(s).index(o)),
				r < 0 && (r = 0),
		...
		n.extend(b.prototype, {
							  ...
							  n.each(f.slides, function (t, o) {
									...
									n.fancybox.setTranslate(o.$slide, { top: 0, left: i - l.left + u }),
										...
										n.fancybox.animate(
											...
											e,
											function () {
												o.$slide.css({ transform: '', opacity: '' }).removeClass('fancybox-slide--next fancybox-slide--previous'),
			...
			getFitPos: function (t) {
				...
				return (
					...
					'image' === t.type
						...
						: 'video' === t.contentType &&
						  ((a = t.opts.width && t.opts.height ? l / d : t.opts.ratio || 16 / 9), d > l / a ? (d = l / a) : l > d * a && (l = d * a)),
					(u.width = l),
					(u.height = d),
					u)
				)
			...
			revealContent: function (t) {
				...
				return (
					...
					'zoom' === e &&
						(t.pos === s.currPos && i && 'image' === t.type && !t.hasError && (l = s.getThumbPos(t)) ? (c = s.getFitPos(t)) : (e = 'fade')),
					'zoom' === e
						? ((s.isAnimating = !0),
			...
			complete: function () {
				...
				!e.isMoved() &&
					...
					o.opts.autoFocus &&
						'html' === o.contentType &&
						((t = o.$content.find('input[autofocus]:enabled:visible:first')), t.length ? t.trigger('focus') : e.focus(null, !0)),
			...
			preload: function (t) {
				var e,
					...
					o = this
				o.group.length < 2 ||
					((n = o.slides[o.currPos + 1]), (e = o.slides[o.currPos - 1]), e && e.type === t && o.loadSlide(e), n && n.type === t && o.loadSlide(n))
			},
			focus: function (t, o) {
				var i,
					a,
			...
			(d.prototype.endSwiping = function (t, e) {
				...
				;(o.sliderLastPos = null),
					'y' == t && !e && Math.abs(o.distanceY) > 50
						? (n.fancybox.animate(o.instance.current.$slide, { top: o.sliderStartPos.top + o.distanceY + 150 * o.velocityY, opacity: 0 }, 200),
