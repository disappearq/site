/*! For license information please see hs-remove-element.js.LICENSE.txt */
!(function (e, t) {
				...
				var c = (function (e) {
					...
					function l() {
						return (
							...
							f.call(this, '[data-hs-remove-element]')
						)
					}
					return (
						(n = l),
						(o = [
							{
								...
								value: function () {
									...
									document.addEventListener('click', function (t) {
										...
										if (n) {
											var o = document.querySelector(n.getAttribute('data-hs-remove-element'))
											o &&
												(o.classList.add('hs-removing'),
												e.afterTransition(o, function () {
													o.remove()
												}))
										}
									})
