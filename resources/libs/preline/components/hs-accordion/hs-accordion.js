/*! For license information please see hs-accordion.js.LICENSE.txt */
!(function (e, t) {
					...
					return (
						...
						(o = [
									...
									;(n.style.display = 'block'),
										...
										this.afterTransition(n, function () {
											e.classList.contains('active') &&
												((n.style.height = ''), t._fireEvent('open', e), t._dispatch('open.hs.accordion', e, e))
										})
								},
							},
							{
								...
								value: function (e) {
									var t = this,
										n = e.querySelector('.hs-accordion-content')
									;(n.style.height = ''.concat(n.scrollHeight, 'px')),
										setTimeout(function () {
											n.style.height = 0
										}),
										this.afterTransition(n, function () {
											e.classList.contains('active') ||
												((n.style.display = ''), t._fireEvent('hide', e), t._dispatch('hide.hs.accordion', e, e))
										}),
							...
							},
							{
								...
								value: function (e) {
									var t = this,
										n = e.closest('.hs-accordion-group')
									n.hasAttribute('data-hs-accordion-always-open') ||
										n.querySelectorAll(this.selector).forEach(function (n) {
											e !== n && t.hide(n)
										})
								},
							},
