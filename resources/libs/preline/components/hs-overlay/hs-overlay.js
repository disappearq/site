								...
								},
								{
									...
									value: function (e, t) {
										var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
											r = new CustomEvent(e, { detail: { payload: o }, bubbles: !0, cancelable: !0, composed: !1 })
										t.dispatchEvent(r)
									},
								},
								{
								...
								},
								{
									...
									value: function (e, t) {
										var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : '',
											r = (window.getComputedStyle(e).getPropertyValue(t) || o).replace(' ', '')
										return r
									},
								},
							]),
						...
						(r = [
							...
							},
							{
								...
								value: function (e) {
									...
									if (e) {
										var o = document.querySelector('.hs-overlay.open'),
											r = 'true' !== this.getClassProperty(e, '--body-scroll', 'false')
										if (o)
											return (
										...
										r && (document.body.style.overflow = 'hidden'),
											...
											setTimeout(function () {
												e.classList.contains('hidden') ||
													(e.classList.add('open'), t._fireEvent('open', e), t._dispatch('open.hs.overlay', e, e), t._focusInput(e))
											}, 50)
									}
								},
							},
							...
							},
							{
								...
								value: function (e) {
									...
									try {
										for (c.s(); !(o = c.n()).done; ) {
											var s = o.value
											s.startsWith('hs-overlay-backdrop-open:') && (a += ' '.concat(s))
										}
									} catch (e) {
										c.e(e)
									} finally {
									...
									var u = 'static' !== this.getClassProperty(e, '--overlay-backdrop', 'true')
									'false' === this.getClassProperty(e, '--overlay-backdrop', 'true') ||
										(n && ((i = document.querySelector(n).cloneNode(!0)).classList.remove('hidden'), (a = i.classList), (i.classList = '')),
										u &&
											i.addEventListener(
												'click',
												function () {
