										...
										;(o.style.display = 'block'),
											...
											this.afterTransition(o, function () {
												e.classList.contains('active') &&
													((o.style.height = ''), t._fireEvent('open', e), t._dispatch('open.hs.accordion', e, e))
											})
									},
								},
								{
									...
									value: function (e) {
										...
										;(o.style.height = ''.concat(o.scrollHeight, 'px')),
											...
											this.afterTransition(o, function () {
												e.classList.contains('active') ||
													((o.style.display = ''), t._fireEvent('hide', e), t._dispatch('hide.hs.accordion', e, e))
											}),
										...
										e.classList.add('open'),
											...
											this.afterTransition(e, function () {
												e.classList.contains('open') &&
													((e.style.height = ''), t._fireEvent('open', e), t._dispatch('open.hs.collapse', e, e))
											})
									},
								},
								{
							...
							(o = [
									...
									value: function (e) {
										...
										this.open(o),
											document.addEventListener(
												'mousemove',
												function e(n) {
													;(n.target.closest(t.selector) && n.target.closest(t.selector) !== o.parentElement.closest(t.selector)) ||
								...
								},
								{
									...
									value: function (e) {
										...
										o ||
											this.afterTransition(e.querySelector('[data-hs-dropdown-transition]') || n, function () {
												r()
											}),
											(n.style.margin = null),
											e.classList.remove('open'),
								...
								},
								{
									...
									value: function (e) {
										var t = e.querySelector('.hs-dropdown-menu'),
											...
											i =
												((window.getComputedStyle(e).getPropertyValue('--adaptive') || 'adaptive').replace(' ', ''),
										...
										e &&
											(this.openNextOverlay &&
												(e.style.transitionDuration = ''.concat(
													1.8 * parseFloat(window.getComputedStyle(e).transitionDuration.replace(/[^\d.-]/g, '')),
													's'
												)),
										...
										document.querySelectorAll(this.selector).forEach(function (t) {
											var o = document.querySelector(t.getAttribute('data-hs-scrollspy')),
												...
												i = t.getAttribute('data-hs-scrollspy-scrollable-parent')
													? document.querySelector(t.getAttribute('data-hs-scrollspy-scrollable-parent'))
													: document
										...
										if (!e.classList.contains('show')) {
											...
											;(0, r.fi)(o, n, {
												...
												e.addEventListener(
													'mouseleave',
													function o(n) {
														;(n.toElement.closest(t.selector) && n.toElement.closest(t.selector) == e) ||
								...
								},
								{
									...
									value: function (e, t) {
										var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
											n = new CustomEvent(e, { detail: { payload: o }, bubbles: !0, cancelable: !0, composed: !1 })
										t.dispatchEvent(n)
									},
								},
								{
				...
				714: (e, t, o) => {
					...
					function m(e, t, o) {
						...
						return (
							(s || (!s && !o)) &&
								(('body' !== p(t) || v(h)) &&
									(b = (r = t) !== n(r) && i(r) ? { scrollLeft: (a = r).scrollLeft, scrollTop: a.scrollTop } : f(r)),
								i(t) ? (((g = u(t, !0)).x += t.clientLeft), (g.y += t.clientTop)) : h && (g.x = y(h))),
							{ x: m.left + b.scrollLeft - g.x, y: m.top + b.scrollTop - g.y, width: m.width, height: m.height }
						)
					}
					function b(e) {
						var t = u(e),
								...
								f = {
									...
									setOptions: function (o) {
										...
										p(),
											...
											(c.scrollParents = { reference: r(e) ? O(e) : e.contextElement ? O(e.contextElement) : [], popper: O(t) })
										var s,
											u,
											d = (function (e) {
												var t = I(e)
									...
									forceUpdate: function () {
										if (!u) {
											var e = c.elements,
												...
												o = e.popper
											if (V(t, o)) {
												;(c.rects = { reference: m(t, _(o), 'fixed' === c.options.strategy), popper: b(o) }),
													(c.reset = !1),
												...
												for (var n = 0; n < c.orderedModifiers.length; n++)
													if (!0 !== c.reset) {
														var r = c.orderedModifiers[n],
															...
															s = void 0 === a ? {} : a,
															l = r.name
														'function' == typeof i && (c = i({ state: c, options: s, name: l, instance: f }) || c)
													} else (c.reset = !1), (n = -1)
											}
										}
									},
					...
					function X(e) {
						...
						if (f) {
							var T = _(o),
								q = 'clientHeight',
								R = 'clientWidth'
							T === n(o) && 'static' !== h((T = d(o))).position && 'absolute' === c && ((q = 'scrollHeight'), (R = 'scrollWidth')),
								(T = T),
								(i === E || ((i === P || i === j) && a === C)) &&
									((L = k), (g -= (y && A.visualViewport ? A.visualViewport.height : T[q]) - r.height), (g *= u ? 1 : -1)),
								(i !== P && ((i !== E && i !== k) || a !== C)) ||
									((x = j), (m -= (y && A.visualViewport ? A.visualViewport.width : T[R]) - r.width), (m *= u ? 1 : -1))
						}
						var D,
						...
						return (
							...
							u
								...
								: Object.assign({}, H, (((t = {})[L] = S ? g + 'px' : ''), (t[x] = O ? m + 'px' : ''), (t.transform = ''), t))
						)
					}
							...
							: ee(
									(function (e) {
										var t,
											...
											l = -n.scrollTop
										return (
											'rtl' === h(r || o).direction && (c += s(o.clientWidth, r ? r.clientWidth : 0) - i),
					...
					function ae(e, t, o) {
						return (
							void 0 === o && (o = { x: 0, y: 0 }),
							{ top: e.top - t.height - o.y, right: e.right - t.width + o.x, bottom: e.bottom - t.height + o.y, left: e.left - t.width - o.x }
						)
					}
					function se(e) {
									...
									null != t.modifiersData.popperOffsets &&
										...
										null != t.modifiersData.arrow &&
											(t.styles.arrow = Object.assign(
												{},
												t.styles.arrow,
												X(Object.assign({}, l, { offsets: t.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: c }))
											)),
											...
											return (
												(e[o] = (function (e, t, o) {
													var n = N(e),
														...
														i = 'function' == typeof o ? o(Object.assign({}, t, { placement: e })) : o,
														a = i[0],
														s = i[1]
													return (a = a || 0), (s = (s || 0) * r), [P, j].indexOf(n) >= 0 ? { x: s, y: a } : { x: a, y: s }
												})(o, t.rects, i)),
												e
											)
										}, {}),
									...
									if (!t.modifiersData[n]._skip) {
										for (
														...
														N(o) === L
															? (function (e, t) {
																	...
																	var d = p.reduce(function (t, o) {
																		return (
																			(t[o] = re(e, { placement: o, boundary: r, rootBoundary: i, padding: a })[N(o)]), t
																		)
																	}, {})
											...
											var q = g[C],
												...
												I = [E, k].indexOf(R) >= 0,
												M = I ? 'width' : 'height',
												V = re(t, { placement: q, boundary: u, rootBoundary: f, altBoundary: p, padding: l }),
												W = I ? (B ? j : P) : B ? k : E
											w[M] > O[M] && (W = G(W))
											var $ = G(W),
												U = []
							...
							},
							{
								...
								fn: function (e) {
									var t = e.state,
										...
										D = 'number' == typeof R ? { mainAxis: R, altAxis: R } : Object.assign({ mainAxis: 0, altAxis: 0 }, R),
							...
							},
							{
								...
								fn: function (e) {
									var t = e.state,
										...
										u = se(c),
										f = se(l)
									;(t.modifiersData[o] = { referenceClippingOffsets: c, popperEscapeOffsets: l, isReferenceHidden: u, hasPopperEscaped: f }),
